...
#define COLUMNAR_STATEMENT_MAP_EXT_LV2_2(...) // error
...
#define COLUMNAR_STATEMENT_MAP_EXT_LV3_2(...) // error
...
#define COLUMNAR_STRUCT(ClsName, ClsDef, ...) \
    COLUMNAR_STATEMENT_MAP_EXT_LV3(COLUMNAR_REGISTER_EVENT_IN_LIST, (PRE_STRUCT_DEF, ClsName, ClsDef,), __VA_ARGS__) \
    struct ClsName \
    { \
        COLUMNAR_JOIN_UNDERSCORE_1(COLUMNAR, ClsDef) \
    }; \
    COLUMNAR_STATEMENT_MAP_EXT_LV3(COLUMNAR_REGISTER_EVENT_IN_LIST, (POST_STRUCT_DEF, ClsName, ClsDef,), __VA_ARGS__)
