...
// Auto generated
#define N_VA_ARGS_RET7(x1, x2, x3, x4, x5, x6, ret, ...) ret
#define N_VA_ARGS(...) N_VA_ARGS_RET7(__VA_ARGS__ 6, 5, 4, 3, 2, 1, 0)
...
#define COLUMNAR_STATEMENT_MAP_EXT_CALL(...) COLUMNAR_STATEMENT_MAP_EXT_CALL_0(__VA_ARGS__) // DEBUG_COLUMNAR_STATEMENT_MAP_EXT_CALL(__VA_ARGS__) // COLUMNAR_STATEMENT_MAP_EXT_CALL_0(__VA_ARGS__)
...
#define COLUMNAR_STATEMENT_MAP_1(...) // error
...
#define COLUMNAR_STATEMENT_MAP_EXT_2(...) // error
...
#define COLUMNAR_STATEMENT_MAP_EXT_4(MapFunc, Args, First, ...) COLUMNAR_STATEMENT_MAP_EXT_CALL(MapFunc, First, COLUMNAR_VA_ARGS_EXPAND Args) COLUMNAR_STATEMENT_MAP_EXT_3(MapFunc, __VA_ARGS__)
#define COLUMNAR_STATEMENT_MAP_EXT_5(MapFunc, Args, First, ...) COLUMNAR_STATEMENT_MAP_EXT_CALL(MapFunc, First, COLUMNAR_VA_ARGS_EXPAND Args) COLUMNAR_STATEMENT_MAP_EXT_4(MapFunc, __VA_ARGS__)
#define COLUMNAR_STATEMENT_MAP_EXT_6(MapFunc, Args, First, ...) COLUMNAR_STATEMENT_MAP_EXT_CALL(MapFunc, First, COLUMNAR_VA_ARGS_EXPAND Args) COLUMNAR_STATEMENT_MAP_EXT_5(MapFunc, __VA_ARGS__)
...
#define COLUMNAR_STATEMENT_FOREACH_0(Pre, Loop, Post, ...) \
    Pre(__VA_ARGS__) \
    COLUMNAR_STATEMENT_MAP2(Loop, __VA_ARGS__) \
    Post(__VA_ARGS__)
...
#define COLUMNAR_STATEMENT_EXPAND_FOREACH(Pre, Loop, Post) Pre, Loop, Post

#define COLUMNAR_STATEMENT_EXPAND_0(Statement) COLUMNAR_JOIN_UNDERSCORE_1(COLUMNAR_STATEMENT_EXPAND, Statement)
...
#define COLUMNAR_STATEMENT_NAME_FOREACH(...) COLUMNAR_STATEMENT_FOREACH

#define COLUMNAR_STATEMENT_NAME_0(Statement) COLUMNAR_JOIN_UNDERSCORE_1(COLUMNAR_STATEMENT_NAME, Statement)
...
#define COLUMNAR_EVENT_LOOKUP_0(FlagEvent, LookupEvent) COLUMNAR_JOIN_UNDERSCORE_1(COLUMNAR_APPEND_UNDERSCORE(COLUMNAR_JOIN_UNDERSCORE_1(COLUMNAR_EVENT, LookupEvent)), FlagEvent) // COLUMNAR_EVENT ## LookupEvent ## __ ## FlagEvent
...
#define COLUMNAR_REGISTER_EVENT_IN_LIST(List, Event, ...) \
    COLUMNAR_STATEMENT_MAP_EXT(COLUMNAR_EVENT_FIRE_FROM_LIST, (Event, COLUMNAR_FLAG_ARGS(COLUMNAR_VA_ARGS_EXPAND List) __VA_ARGS__), COLUMNAR_FLAG_NAME(COLUMNAR_VA_ARGS_EXPAND List)())

#define COLUMNAR_STRUCT(ClsName, ClsDef, ...) \
    COLUMNAR_STATEMENT_MAP_EXT(COLUMNAR_REGISTER_EVENT_IN_LIST, (PRE_STRUCT, ClsName, ClsDef,), __VA_ARGS__) \
    struct ClsName \
    { \
        COLUMNAR_JOIN_UNDERSCORE_1(COLUMNAR, ClsDef) \
    }; \
    COLUMNAR_STATEMENT_MAP_EXT(COLUMNAR_REGISTER_EVENT_IN_LIST, (POST_STRUCT, ClsName, ClsDef,), __VA_ARGS__)
